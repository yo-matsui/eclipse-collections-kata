...
public class Exercise2Test extends PetDomainForKata
{
    ...
    {
        Person result = this.people.detect(person -> person.getFirstName().equals("Mary") && person.getLastName().equals("Smith"));
    ...
    public void getAllPetsOfAllPeople()
    {
        ...
        MutableSet<PetType> petTypes = this.people.flatCollect(function, UnifiedSet.newSet());
        Assert.assertEquals(
